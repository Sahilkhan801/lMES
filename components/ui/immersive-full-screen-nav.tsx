...
function CustomNavbar({
  links = [],
  images = ["https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80", "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=800&q=80"],
  agencyName = "LMES Portal",
  socials = [
    { type: "instagram", href: "#" },
    { type: "facebook", href: "#" },
    { type: "twitter", href: "#" },
  ...
  tagline = "Legal Metrology Enforcement System • DoCA",
  isOpen = false,
  overlayBg = "#0f172a",
  delay = 1,
...
const NAV_CONTENT: Partial<CustomNavbarProps> = {
  ...
  tagline: "Legal Metrology Enforcement Gateway",
  location: "New Delhi, India",
  links: [
